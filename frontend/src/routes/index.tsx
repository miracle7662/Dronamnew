...
const FloorMaster = React.lazy(() => import('../views/apps/FloorMaster'))
const NationalityMaster = React.lazy(() => import('../views/apps/NationalityMaster'))
const NewspaperMaster = React.lazy(() => import('../views/apps/Newspapermaster'))
