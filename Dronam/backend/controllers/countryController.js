...
//   const { country_name, country_code, capital,status, created_by_id } = req.body;
...
//   const { country_name, country_code, capital,status, updated_by_id } = req.body;
//   const { id } = req.params;
...
//       WHERE country_id = ?
//     `);
//     const result = stmt.run(country_name, country_code, capital, status,updated_by_id, id);
